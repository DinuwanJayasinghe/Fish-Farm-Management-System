...
public class JFrame_5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Time.setBounds(720, 90, 160, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Details of Zebra");
        jPanel1.add(jLabel2);
        ...
        jButton_Back.setBounds(30, 490, 90, 30);
        ...
        jButton_Add.setBounds(180, 490, 90, 30);
        ...
        jButton_Delete.setBounds(330, 490, 90, 30);
        ...
        jTextField_Fish_ID.setBounds(180, 170, 220, 30);

        text_size.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                text_sizeKeyReleased(evt);
            }
        });
        jPanel1.add(text_size);
        text_size.setBounds(180, 290, 220, 30);
        ...
        jTextField_Price.setBounds(180, 350, 220, 30);
        ...
        jTextField_Availability.setBounds(180, 410, 220, 30);

        jComboBox_Varaties.setMaximumRowCount(14);
        jComboBox_Varaties.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "~Select Vairaties of Zebra~", "Blue Zebra ", "Green Zebra ", "Tellow Zebra ", "Red Zebra " }));
        jComboBox_Varaties.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jComboBox_VaratiesItemStateChanged(evt);
            }
        });
        jComboBox_Varaties.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox_VaratiesActionPerformed(evt);
            }
        });
        jPanel1.add(jComboBox_Varaties);
        jComboBox_Varaties.setBounds(180, 230, 220, 30);
        ...
        jLabel_Set_availability.setBounds(180, 440, 220, 30);
        ...
        jLabel_CheckFish_Id.setBounds(180, 200, 220, 30);
        ...
        jLabel_Select_Varaties.setBounds(180, 260, 220, 30);
        ...
        jLabel_Set_Size.setBounds(180, 320, 220, 30);
        ...
        jLabel1_set_Price.setBounds(180, 380, 220, 30);
        ...
        jScrollPane1.setBounds(430, 170, 450, 270);

        jLabel1.setIcon(new javax.swing.ImageIcon("D:\\My Works\\My Java Projects\\Fish_Farm\\Images\\Full-Screen-HD-Wallpapers-9.jpg")); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void text_sizeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_text_sizeKeyReleased
        jLabel_Set_Size.setText(null);
    }//GEN-LAST:event_text_sizeKeyReleased
    ...
    private void jButton_AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_AddActionPerformed
        ...
        if (jTextField_Fish_ID.getText().trim().isEmpty() && jComboBox_Varaties.getSelectedItem().equals("~Select Vairaties of Zebra ~") && jTextField_Availability.getText().trim().isEmpty() && jTextField_Price.getText().trim().isEmpty() && text_size.getText().trim().isEmpty()) {
        ...
        } else if (jComboBox_Varaties.getSelectedItem().equals("~Select Vairaties of Zebra ~")) {
        ...
        } else if (text_size.getText().trim().isEmpty()) {
            ...
            try {
                ...
                String query = "INSERT INTO details_of_zebra(Fish_ID, Available_Varieties, Size, Price, Availability)VALUES(?,?,?,?,?)";

                PreparedStatement pst = con.prepareStatement(query);

                pst.setString(1, jTextField_Fish_ID.getText());
                pst.setString(2, jComboBox_Varaties.getSelectedItem().toString());
                pst.setString(3, text_size.getText());
                ...
                Logger.getLogger(JFrame_5.class.getName()).log(Level.SEVERE, null, ex);
                getToolkit().beep();
                JOptionPane.showMessageDialog(null, ex);

                jTextField_Fish_ID.setText(null);
                jComboBox_Varaties.setSelectedItem("~Select Vairaties of Zebra~");
                jTextField_Availability.setText(null);
                jTextField_Price.setText(null);
                text_size.setText(null);
                jLabel_CheckFish_Id.setText(null);
    ...
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        if (jTextField_Fish_ID.getText().trim().isEmpty()) {
            ...
            try {
                ...
                String query = "DELETE FROM details_of_zebra WHERE Fish_ID=?";
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        ...
        if (jTextField_Fish_ID.getText().trim().isEmpty() && jComboBox_Varaties.getSelectedItem().equals("~Select Vairaties of Zebra ~") && jTextField_Availability.getText().trim().isEmpty() && jTextField_Price.getText().trim().isEmpty() && text_size.getText().trim().isEmpty()) {
            ...
            try {
                ...
                String Query = "UPDATE details_of_zebra SET Available_Varieties=? ,Size=? ,Price=? ,Availability=? WHERE Fish_ID=?";

                PreparedStatement pst = con.prepareStatement(Query);

                pst.setString(5, jTextField_Fish_ID.getText());
                pst.setString(1, jComboBox_Varaties.getSelectedItem().toString());
                pst.setString(2, text_size.getText());
    ...
    private void jButton_SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_SearchActionPerformed
        ...
        if (jTextField_Fish_ID.getText().trim().isEmpty()) {
            ...
            try {
                ...
                String sql = "SELECT * FROM details_of_zebra WHERE Fish_ID = '" + jTextField_Fish_ID.getText() + "'";
    ...
    private void jComboBox_VaratiesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox_VaratiesActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jComboBox_VaratiesActionPerformed
    ...
    public void showTableData() {
        ...
        try {
            ...
            String queary = "SELECT * FROM details_of_zebra;";
